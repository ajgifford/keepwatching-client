...
- `src/components/common/` - Reusable components organized by feature:
  ...
  - `statistics/` - Statistics dialogs for account and profile analytics (uses components from
...
- Enhanced statistics include: velocity, timeline, binge patterns, streaks, time-to-watch, seasonal trends, milestones,
  content depth, content discovery, abandonment risk, unaired content, and profile comparisons
- UI components provided by `@ajgifford/keepwatching-ui` package (`EnhancedAccountStatisticsDashboard` and
