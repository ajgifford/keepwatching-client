...
import { ApiErrorResponse } from '../../app/model/errors';
...
export function ErrorComponent({ error, hideHomeButton = false }: ErrorPropTypes) {
    ...
    >
      ...
      >
        ...
        >
          ...
          {!hideHomeButton && (
            <Button variant="contained" color="primary" startIcon={<HomeIcon />} onClick={() => navigate('/home')}>
              Home
            </Button>
          )}
        </Box>
